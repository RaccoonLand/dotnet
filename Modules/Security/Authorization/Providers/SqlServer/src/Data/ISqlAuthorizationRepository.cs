...
/// per-user allowed request set from the configured stored procedures. Optional
/// <see cref="Configuration.SqlAuthorizationOptions.ServiceName"/> /
/// <see cref="Configuration.SqlAuthorizationOptions.ApplicationName"/> values are passed as procedure
/// parameters when set. Each call returns a set of request full-names; the provider checks membership in
/// memory. Connection, timeout, and SQL failures throw; they are not converted to an authorization deny.
/// </summary>
