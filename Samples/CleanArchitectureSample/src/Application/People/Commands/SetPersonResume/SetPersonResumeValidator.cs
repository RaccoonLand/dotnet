...
public sealed class SetPersonResumeValidator : AbstractValidator<SetPersonResumeCommand>
{
    public SetPersonResumeValidator(IMessageLocalization localization)
    {
